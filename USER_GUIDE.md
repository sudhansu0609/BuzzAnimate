...
![A caption on the picture](docs/images/captions_on_the_picture.png)
...
| Bare | Forest | City |
|---|---|---|
| ![A staged set with nothing between ground and sky](docs/images/scenery_bare.png) | ![The same brief with a forest](docs/images/scenery_forest.png) | ![The same brief as a city street](docs/images/scenery_city.png) |
...
![Five moments across a sit](docs/images/action_sit.png)
...
![Five moments across a point](docs/images/action_point.png)
